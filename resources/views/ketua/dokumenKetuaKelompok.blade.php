                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="rencanaketua" role="tabpanel" aria-labelledby="rencana-tab">
                        <div class="card shadow-sm mt-3">
                            <div class="card-header bg-light" style="text-align">
                                    ...
                                    @foreach ($rencanas as $rencana)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('DokumenController.editRencana', $rencana->id_rencana) }}" class="btn btn-success"><i class="bi bi-pencil"></i></a>
                                                <a href="{{ route('DokumenController.show', $rencana->id_rencana) }}" target="_blank" class="btn btn-primary"><i class="bi bi-eye-fill"></i></a>
                                                <form action="{{ route('DokumenController.deleteRencana', $rencana->id_rencana) }}" method="POST" style="display:inline;">
                                                    @csrf
                                ...
                                <table class="table table-striped">
                                    ...
                                    @foreach ($logbooks as $logbook)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('DokumenController.editLogbook', $logbook->id_logbook) }}" class="btn btn-success btn-sm"><i class="bi bi-pencil"></i></a>
                                                <form action="{{ route('DokumenController.deleteLogbook', $logbook->id_logbook) }}" method="POST" style="display:inline;">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-danger" onclick="return confirm('Apakah anda yakin menghapus?')">
                                                        <i class="bi bi-trash-fill"></i>
                                    ...
                                    <tbody>			
                                        @foreach ($laporans as $laporan)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="{{ route('DokumenController.editLaporan', $laporan->id_laporan) }}" class="btn btn-success"><i class="bi bi-pencil"></i></a>
                                                    <a href="{{ route('DokumenController.show', $laporan->id_laporan) }}" target="_blank" class="btn btn-primary"><i class="bi bi-eye-fill"></i></a>
                                                    <form action="{{ route('DokumenController.deleteLaporan', $laporan->id_laporan) }}" method="POST" style="display:inline;">
                                                    @csrf
                                                    @method('DELETE') 
                                                    <button type="submit" class="btn btn-danger" onclick="return confirm('Apakah anda yakin menghapus?')">
                                                        <i class="bi bi-trash-fill"></i>
